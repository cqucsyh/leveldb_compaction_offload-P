...
module stage4_real_internal_key_two_way_merge_stage5_multiblock_axil_top #(
    ...
    reg [63:0] r_mid_base;
    reg [63:0] r_src0_base0;
    reg [31:0] r_src0_size0;
    reg [63:0] r_src1_base0;
    reg [31:0] r_src1_size0;
    reg [63:0] r_dst_base0;
    reg [63:0] r_src0_base1;
    reg [31:0] r_src0_size1;
    reg [63:0] r_src1_base1;
    reg [31:0] r_src1_size1;
    reg [63:0] r_dst_base1;
    ...
    reg [63:0] cfg_src0_base0_axil;
    reg [31:0] cfg_src0_size0_axil;
    reg [63:0] cfg_src1_base0_axil;
    reg [31:0] cfg_src1_size0_axil;
    reg [63:0] cfg_dst_base0_axil;
    reg [63:0] cfg_src0_base1_axil;
    reg [31:0] cfg_src0_size1_axil;
    reg [63:0] cfg_src1_base1_axil;
    reg [31:0] cfg_src1_size1_axil;
    reg [63:0] cfg_dst_base1_axil;
    ...
    reg [63:0] cfg_src0_base0_ui_ff1;
    reg [63:0] cfg_src0_base0_ui_ff2;
    reg [31:0] cfg_src0_size0_ui_ff1;
    reg [31:0] cfg_src0_size0_ui_ff2;
    reg [63:0] cfg_src1_base0_ui_ff1;
    reg [63:0] cfg_src1_base0_ui_ff2;
    reg [31:0] cfg_src1_size0_ui_ff1;
    reg [31:0] cfg_src1_size0_ui_ff2;
    reg [63:0] cfg_dst_base0_ui_ff1;
    reg [63:0] cfg_dst_base0_ui_ff2;
    reg [63:0] cfg_src0_base1_ui_ff1;
    reg [63:0] cfg_src0_base1_ui_ff2;
    reg [31:0] cfg_src0_size1_ui_ff1;
    reg [31:0] cfg_src0_size1_ui_ff2;
    reg [63:0] cfg_src1_base1_ui_ff1;
    reg [63:0] cfg_src1_base1_ui_ff2;
    reg [31:0] cfg_src1_size1_ui_ff1;
    reg [31:0] cfg_src1_size1_ui_ff2;
    reg [63:0] cfg_dst_base1_ui_ff1;
    reg [63:0] cfg_dst_base1_ui_ff2;
    ...
    wire [31:0] dst0_output_block_bytes_ui;
    wire [31:0] dst1_output_block_bytes_ui;
    ...
    reg [31:0] dst0_output_block_bytes_axil_ff1;
    reg [31:0] dst0_output_block_bytes_axil_ff2;
    reg [31:0] dst1_output_block_bytes_axil_ff1;
    reg [31:0] dst1_output_block_bytes_axil_ff2;
        ...
        if (!axil_aresetn) begin
            ...
            if (ar_hs) begin
                ...
                case (s_axil_araddr)
                    ...
                    REG_SRC0_BASE0_LO:                     s_axil_rdata <= r_src0_base0[31:0];
                    REG_SRC0_BASE0_HI:                     s_axil_rdata <= r_src0_base0[63:32];
                    REG_SRC0_SIZE0:                        s_axil_rdata <= r_src0_size0;
                    REG_SRC1_BASE0_LO:                     s_axil_rdata <= r_src1_base0[31:0];
                    REG_SRC1_BASE0_HI:                     s_axil_rdata <= r_src1_base0[63:32];
                    REG_SRC1_SIZE0:                        s_axil_rdata <= r_src1_size0;
                    REG_DST_BASE0_LO:                      s_axil_rdata <= r_dst_base0[31:0];
                    REG_DST_BASE0_HI:                      s_axil_rdata <= r_dst_base0[63:32];
                    REG_SRC0_BASE1_LO:                     s_axil_rdata <= r_src0_base1[31:0];
                    REG_SRC0_BASE1_HI:                     s_axil_rdata <= r_src0_base1[63:32];
                    REG_SRC0_SIZE1:                        s_axil_rdata <= r_src0_size1;
                    REG_SRC1_BASE1_LO:                     s_axil_rdata <= r_src1_base1[31:0];
                    REG_SRC1_BASE1_HI:                     s_axil_rdata <= r_src1_base1[63:32];
                    REG_SRC1_SIZE1:                        s_axil_rdata <= r_src1_size1;
                    REG_DST_BASE1_LO:                      s_axil_rdata <= r_dst_base1[31:0];
                    REG_DST_BASE1_HI:                      s_axil_rdata <= r_dst_base1[63:32];
                    ...
                    REG_DST0_OUTPUT_BLOCK_BYTES:           s_axil_rdata <= dst0_output_block_bytes_axil_ff2;
                    REG_DST1_OUTPUT_BLOCK_BYTES:           s_axil_rdata <= dst1_output_block_bytes_axil_ff2;
    ...
    always @(posedge axil_aclk) begin
        if (!axil_aresetn) begin
            ...
            cfg_src0_base0_axil                      <= 64'h0;
            cfg_src0_size0_axil                      <= 32'h0;
            cfg_src1_base0_axil                      <= 64'h0;
            cfg_src1_size0_axil                      <= 32'h0;
            cfg_dst_base0_axil                       <= 64'h0;
            cfg_src0_base1_axil                      <= 64'h0;
            cfg_src0_size1_axil                      <= 32'h0;
            cfg_src1_base1_axil                      <= 64'h0;
            cfg_src1_size1_axil                      <= 32'h0;
            cfg_dst_base1_axil                       <= 64'h0;
            busy_axil_ff1                            <= 1'b0;
            busy_axil_ff2                            <= 1'b0;
            ...
            dst0_output_block_bytes_axil_ff1        <= 32'h0;
            dst0_output_block_bytes_axil_ff2        <= 32'h0;
            dst1_output_block_bytes_axil_ff1        <= 32'h0;
            dst1_output_block_bytes_axil_ff2        <= 32'h0;
            ...
            cfg_src0_base0_axil       <= r_src0_base0;
            cfg_src0_size0_axil       <= r_src0_size0;
            cfg_src1_base0_axil       <= r_src1_base0;
            cfg_src1_size0_axil       <= r_src1_size0;
            cfg_dst_base0_axil        <= r_dst_base0;
            cfg_src0_base1_axil       <= r_src0_base1;
            cfg_src0_size1_axil       <= r_src0_size1;
            cfg_src1_base1_axil       <= r_src1_base1;
            cfg_src1_size1_axil       <= r_src1_size1;
            cfg_dst_base1_axil        <= r_dst_base1;
            ...
            dst0_output_block_bytes_axil_ff1 <= dst0_output_block_bytes_ui;
            dst0_output_block_bytes_axil_ff2 <= dst0_output_block_bytes_axil_ff1;
            dst1_output_block_bytes_axil_ff1 <= dst1_output_block_bytes_ui;
            dst1_output_block_bytes_axil_ff2 <= dst1_output_block_bytes_axil_ff1;
            ...
            if (can_accept_write && awaddr_valid && w_hs) begin
                case (awaddr_lat)
                    ...
                    REG_SRC0_BASE0_LO: begin
                        if (s_axil_wstrb[0]) r_src0_base0[7:0]   <= s_axil_wdata[7:0];
                        if (s_axil_wstrb[1]) r_src0_base0[15:8]  <= s_axil_wdata[15:8];
                        if (s_axil_wstrb[2]) r_src0_base0[23:16] <= s_axil_wdata[23:16];
                        if (s_axil_wstrb[3]) r_src0_base0[31:24] <= s_axil_wdata[31:24];
                    end
                    REG_SRC0_BASE0_HI: begin
                        if (s_axil_wstrb[0]) r_src0_base0[39:32] <= s_axil_wdata[7:0];
                        if (s_axil_wstrb[1]) r_src0_base0[47:40] <= s_axil_wdata[15:8];
                        if (s_axil_wstrb[2]) r_src0_base0[55:48] <= s_axil_wdata[23:16];
                        if (s_axil_wstrb[3]) r_src0_base0[63:56] <= s_axil_wdata[31:24];
                    end
                    REG_SRC0_SIZE0: begin
                        if (s_axil_wstrb[0]) r_src0_size0[7:0]   <= s_axil_wdata[7:0];
                        if (s_axil_wstrb[1]) r_src0_size0[15:8]  <= s_axil_wdata[15:8];
                        if (s_axil_wstrb[2]) r_src0_size0[23:16] <= s_axil_wdata[23:16];
                        if (s_axil_wstrb[3]) r_src0_size0[31:24] <= s_axil_wdata[31:24];
                    end
                    REG_SRC1_BASE0_LO: begin
                        if (s_axil_wstrb[0]) r_src1_base0[7:0]   <= s_axil_wdata[7:0];
                        if (s_axil_wstrb[1]) r_src1_base0[15:8]  <= s_axil_wdata[15:8];
                        if (s_axil_wstrb[2]) r_src1_base0[23:16] <= s_axil_wdata[23:16];
                        if (s_axil_wstrb[3]) r_src1_base0[31:24] <= s_axil_wdata[31:24];
                    end
                    REG_SRC1_BASE0_HI: begin
                        if (s_axil_wstrb[0]) r_src1_base0[39:32] <= s_axil_wdata[7:0];
                        if (s_axil_wstrb[1]) r_src1_base0[47:40] <= s_axil_wdata[15:8];
                        if (s_axil_wstrb[2]) r_src1_base0[55:48] <= s_axil_wdata[23:16];
                        if (s_axil_wstrb[3]) r_src1_base0[63:56] <= s_axil_wdata[31:24];
                    end
                    REG_SRC1_SIZE0: begin
                        if (s_axil_wstrb[0]) r_src1_size0[7:0]   <= s_axil_wdata[7:0];
                        if (s_axil_wstrb[1]) r_src1_size0[15:8]  <= s_axil_wdata[15:8];
                        if (s_axil_wstrb[2]) r_src1_size0[23:16] <= s_axil_wdata[23:16];
                        if (s_axil_wstrb[3]) r_src1_size0[31:24] <= s_axil_wdata[31:24];
                    end
                    REG_DST_BASE0_LO: begin
                        if (s_axil_wstrb[0]) r_dst_base0[7:0]   <= s_axil_wdata[7:0];
                        if (s_axil_wstrb[1]) r_dst_base0[15:8]  <= s_axil_wdata[15:8];
                        if (s_axil_wstrb[2]) r_dst_base0[23:16] <= s_axil_wdata[23:16];
                        if (s_axil_wstrb[3]) r_dst_base0[31:24] <= s_axil_wdata[31:24];
                    end
                    REG_DST_BASE0_HI: begin
                        if (s_axil_wstrb[0]) r_dst_base0[39:32] <= s_axil_wdata[7:0];
                        if (s_axil_wstrb[1]) r_dst_base0[47:40] <= s_axil_wdata[15:8];
                        if (s_axil_wstrb[2]) r_dst_base0[55:48] <= s_axil_wdata[23:16];
                        if (s_axil_wstrb[3]) r_dst_base0[63:56] <= s_axil_wdata[31:24];
                    end
                    REG_SRC0_BASE1_LO: begin
                        if (s_axil_wstrb[0]) r_src0_base1[7:0]   <= s_axil_wdata[7:0];
                        if (s_axil_wstrb[1]) r_src0_base1[15:8]  <= s_axil_wdata[15:8];
                        if (s_axil_wstrb[2]) r_src0_base1[23:16] <= s_axil_wdata[23:16];
                        if (s_axil_wstrb[3]) r_src0_base1[31:24] <= s_axil_wdata[31:24];
                    end
                    REG_SRC0_BASE1_HI: begin
                        if (s_axil_wstrb[0]) r_src0_base1[39:32] <= s_axil_wdata[7:0];
                        if (s_axil_wstrb[1]) r_src0_base1[47:40] <= s_axil_wdata[15:8];
                        if (s_axil_wstrb[2]) r_src0_base1[55:48] <= s_axil_wdata[23:16];
                        if (s_axil_wstrb[3]) r_src0_base1[63:56] <= s_axil_wdata[31:24];
                    end
                    REG_SRC0_SIZE1: begin
                        if (s_axil_wstrb[0]) r_src0_size1[7:0]   <= s_axil_wdata[7:0];
                        if (s_axil_wstrb[1]) r_src0_size1[15:8]  <= s_axil_wdata[15:8];
                        if (s_axil_wstrb[2]) r_src0_size1[23:16] <= s_axil_wdata[23:16];
                        if (s_axil_wstrb[3]) r_src0_size1[31:24] <= s_axil_wdata[31:24];
                    end
                    REG_SRC1_BASE1_LO: begin
                        if (s_axil_wstrb[0]) r_src1_base1[7:0]   <= s_axil_wdata[7:0];
                        if (s_axil_wstrb[1]) r_src1_base1[15:8]  <= s_axil_wdata[15:8];
                        if (s_axil_wstrb[2]) r_src1_base1[23:16] <= s_axil_wdata[23:16];
                        if (s_axil_wstrb[3]) r_src1_base1[31:24] <= s_axil_wdata[31:24];
                    end
                    REG_SRC1_BASE1_HI: begin
                        if (s_axil_wstrb[0]) r_src1_base1[39:32] <= s_axil_wdata[7:0];
                        if (s_axil_wstrb[1]) r_src1_base1[47:40] <= s_axil_wdata[15:8];
                        if (s_axil_wstrb[2]) r_src1_base1[55:48] <= s_axil_wdata[23:16];
                        if (s_axil_wstrb[3]) r_src1_base1[63:56] <= s_axil_wdata[31:24];
                    end
                    REG_SRC1_SIZE1: begin
                        if (s_axil_wstrb[0]) r_src1_size1[7:0]   <= s_axil_wdata[7:0];
                        if (s_axil_wstrb[1]) r_src1_size1[15:8]  <= s_axil_wdata[15:8];
                        if (s_axil_wstrb[2]) r_src1_size1[23:16] <= s_axil_wdata[23:16];
                        if (s_axil_wstrb[3]) r_src1_size1[31:24] <= s_axil_wdata[31:24];
                    end
                    REG_DST_BASE1_LO: begin
                        if (s_axil_wstrb[0]) r_dst_base1[7:0]   <= s_axil_wdata[7:0];
                        if (s_axil_wstrb[1]) r_dst_base1[15:8]  <= s_axil_wdata[15:8];
                        if (s_axil_wstrb[2]) r_dst_base1[23:16] <= s_axil_wdata[23:16];
                        if (s_axil_wstrb[3]) r_dst_base1[31:24] <= s_axil_wdata[31:24];
                    end
                    REG_DST_BASE1_HI: begin
                        if (s_axil_wstrb[0]) r_dst_base1[39:32] <= s_axil_wdata[7:0];
                        if (s_axil_wstrb[1]) r_dst_base1[47:40] <= s_axil_wdata[15:8];
                        if (s_axil_wstrb[2]) r_dst_base1[55:48] <= s_axil_wdata[23:16];
                        if (s_axil_wstrb[3]) r_dst_base1[63:56] <= s_axil_wdata[31:24];
                    end
                    default: begin
                    end
                endcase
    ...
    always @(posedge ui_aclk) begin
        if (!ui_aresetn) begin
            ...
            cfg_src0_base0_ui_ff1    <= 64'h0;
            cfg_src0_base0_ui_ff2    <= 64'h0;
            cfg_src0_size0_ui_ff1    <= 32'h0;
            cfg_src0_size0_ui_ff2    <= 32'h0;
            cfg_src1_base0_ui_ff1    <= 64'h0;
            cfg_src1_base0_ui_ff2    <= 64'h0;
            cfg_src1_size0_ui_ff1    <= 32'h0;
            cfg_src1_size0_ui_ff2    <= 32'h0;
            cfg_dst_base0_ui_ff1     <= 64'h0;
            cfg_dst_base0_ui_ff2     <= 64'h0;
            cfg_src0_base1_ui_ff1    <= 64'h0;
            cfg_src0_base1_ui_ff2    <= 64'h0;
            cfg_src0_size1_ui_ff1    <= 32'h0;
            cfg_src0_size1_ui_ff2    <= 32'h0;
            cfg_src1_base1_ui_ff1    <= 64'h0;
            cfg_src1_base1_ui_ff2    <= 64'h0;
            cfg_src1_size1_ui_ff1    <= 32'h0;
            cfg_src1_size1_ui_ff2    <= 32'h0;
            cfg_dst_base1_ui_ff1     <= 64'h0;
            cfg_dst_base1_ui_ff2     <= 64'h0;
            done_ui_d                <= 1'b0;
            error_ui_d               <= 1'b0;
            done_toggle_ui           <= 1'b0;
            ...
            cfg_src0_base0_ui_ff1    <= cfg_src0_base0_axil;
            cfg_src0_base0_ui_ff2    <= cfg_src0_base0_ui_ff1;
            cfg_src0_size0_ui_ff1    <= cfg_src0_size0_axil;
            cfg_src0_size0_ui_ff2    <= cfg_src0_size0_ui_ff1;
            cfg_src1_base0_ui_ff1    <= cfg_src1_base0_axil;
            cfg_src1_base0_ui_ff2    <= cfg_src1_base0_ui_ff1;
            cfg_src1_size0_ui_ff1    <= cfg_src1_size0_axil;
            cfg_src1_size0_ui_ff2    <= cfg_src1_size0_ui_ff1;
            cfg_dst_base0_ui_ff1     <= cfg_dst_base0_axil;
            cfg_dst_base0_ui_ff2     <= cfg_dst_base0_ui_ff1;
            cfg_src0_base1_ui_ff1    <= cfg_src0_base1_axil;
            cfg_src0_base1_ui_ff2    <= cfg_src0_base1_ui_ff1;
            cfg_src0_size1_ui_ff1    <= cfg_src0_size1_axil;
            cfg_src0_size1_ui_ff2    <= cfg_src0_size1_ui_ff1;
            cfg_src1_base1_ui_ff1    <= cfg_src1_base1_axil;
            cfg_src1_base1_ui_ff2    <= cfg_src1_base1_ui_ff1;
            cfg_src1_size1_ui_ff1    <= cfg_src1_size1_axil;
            cfg_src1_size1_ui_ff2    <= cfg_src1_size1_ui_ff1;
            cfg_dst_base1_ui_ff1     <= cfg_dst_base1_axil;
            cfg_dst_base1_ui_ff2     <= cfg_dst_base1_ui_ff1;
    ...
    stage4_real_internal_key_two_way_merge_stage5_multiblock_top #(
        ...
        .src0_base_addr0(cfg_src0_base0_ui_ff2),
        .src0_byte_count0(cfg_src0_size0_ui_ff2),
        .src1_base_addr0(cfg_src1_base0_ui_ff2),
        .src1_byte_count0(cfg_src1_size0_ui_ff2),
        .dst_base_addr0(cfg_dst_base0_ui_ff2),
        .src0_base_addr1(cfg_src0_base1_ui_ff2),
        .src0_byte_count1(cfg_src0_size1_ui_ff2),
        .src1_base_addr1(cfg_src1_base1_ui_ff2),
        .src1_byte_count1(cfg_src1_size1_ui_ff2),
        .dst_base_addr1(cfg_dst_base1_ui_ff2),
        ...
        .dst0_output_block_bytes(dst0_output_block_bytes_ui),
        .dst1_output_block_bytes(dst1_output_block_bytes_ui),
