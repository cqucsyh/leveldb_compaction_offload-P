...
module stage4_real_internal_key_two_way_merge_stage5_multiblock_top #(
    ...
    parameter integer MAX_BLOCK_PAIRS             = 2
) (
    input  wire                          clk,
    input  wire                          rstn,
    input  wire                          clear,
    ...
    input  wire [AXI_ADDR_WIDTH-1:0]     src0_base_addr0,
    input  wire [31:0]                   src0_byte_count0,
    input  wire [AXI_ADDR_WIDTH-1:0]     src1_base_addr0,
    input  wire [31:0]                   src1_byte_count0,
    input  wire [AXI_ADDR_WIDTH-1:0]     dst_base_addr0,
    input  wire [AXI_ADDR_WIDTH-1:0]     src0_base_addr1,
    input  wire [31:0]                   src0_byte_count1,
    input  wire [AXI_ADDR_WIDTH-1:0]     src1_base_addr1,
    input  wire [31:0]                   src1_byte_count1,
    input  wire [AXI_ADDR_WIDTH-1:0]     dst_base_addr1,
    ...
    output reg  [31:0]                   dst0_output_block_bytes,
    output reg  [31:0]                   dst1_output_block_bytes,
    ...
    wire [AXI_ADDR_WIDTH-1:0] current_src0_base_addr = (active_block_index == 32'd0) ? src0_base_addr0 : src0_base_addr1;
    wire [31:0]               current_src0_byte_count = (active_block_index == 32'd0) ? src0_byte_count0 : src0_byte_count1;
    wire [AXI_ADDR_WIDTH-1:0] current_src1_base_addr = (active_block_index == 32'd0) ? src1_base_addr0 : src1_base_addr1;
    wire [31:0]               current_src1_byte_count = (active_block_index == 32'd0) ? src1_byte_count0 : src1_byte_count1;
    wire [AXI_ADDR_WIDTH-1:0] current_dst_base_addr = (active_block_index == 32'd0) ? dst_base_addr0 : dst_base_addr1;
    ...
    always @(posedge clk) begin
        if (!rstn) begin
            ...
            dst0_output_block_bytes               <= 32'd0;
            dst1_output_block_bytes               <= 32'd0;
            ...
            case (state)
                ...
                ST_WAIT: begin
                    if (inner_error) begin
                        ...
                        if (active_block_index == 32'd0) begin
                            dst0_output_block_bytes <= inner_stage5_output_block_bytes;
                        end else begin
                            dst1_output_block_bytes <= inner_stage5_output_block_bytes;
                        end
