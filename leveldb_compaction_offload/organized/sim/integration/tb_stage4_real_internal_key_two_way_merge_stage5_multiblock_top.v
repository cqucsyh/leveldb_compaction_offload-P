...
module tb_stage4_real_internal_key_two_way_merge_stage5_multiblock_top;
    ...
    localparam [63:0] MID_ADDR        = 64'h0000_0000_0000_0400;
    ...
    reg  [AXI_ADDR_WIDTH-1:0]   src0_base_addr0;
    reg  [31:0]                 src0_byte_count0;
    reg  [AXI_ADDR_WIDTH-1:0]   src1_base_addr0;
    reg  [31:0]                 src1_byte_count0;
    reg  [AXI_ADDR_WIDTH-1:0]   dst_base_addr0;
    reg  [AXI_ADDR_WIDTH-1:0]   src0_base_addr1;
    reg  [31:0]                 src0_byte_count1;
    reg  [AXI_ADDR_WIDTH-1:0]   src1_base_addr1;
    reg  [31:0]                 src1_byte_count1;
    reg  [AXI_ADDR_WIDTH-1:0]   dst_base_addr1;
    ...
    wire [31:0]                 dst0_output_block_bytes;
    wire [31:0]                 dst1_output_block_bytes;
    ...
    stage4_real_internal_key_two_way_merge_stage5_multiblock_top #(
        ...
        .src0_base_addr0(src0_base_addr0),
        .src0_byte_count0(src0_byte_count0),
        .src1_base_addr0(src1_base_addr0),
        .src1_byte_count0(src1_byte_count0),
        .dst_base_addr0(dst_base_addr0),
        .src0_base_addr1(src0_base_addr1),
        .src0_byte_count1(src0_byte_count1),
        .src1_base_addr1(src1_base_addr1),
        .src1_byte_count1(src1_byte_count1),
        .dst_base_addr1(dst_base_addr1),
        ...
        .dst0_output_block_bytes(dst0_output_block_bytes),
        .dst1_output_block_bytes(dst1_output_block_bytes),
    ...
    initial begin
        ...
        clear = 1'b0;
        start = 1'b0;
        block_pair_count = 32'd2;
        src0_base_addr0 = SRC0_ADDR0;
        src0_byte_count0 = SRC0B0_BYTES;
        src1_base_addr0 = SRC1_ADDR0;
        src1_byte_count0 = SRC1B0_BYTES;
        dst_base_addr0 = DST_ADDR0;
        src0_base_addr1 = SRC0_ADDR1;
        src0_byte_count1 = SRC0B1_BYTES;
        src1_base_addr1 = SRC1_ADDR1;
        src1_byte_count1 = SRC1B1_BYTES;
        dst_base_addr1 = DST_ADDR1;
        ...
        if (wait_cycles >= 5000) begin
            $display("timeout waiting for multiblock done");
            ...
            $display("inner busy=%0d done=%0d error=%0d inner_done_d=%0d", dut.inner_busy, dut.inner_done, dut.inner_error, dut.inner_done_d);
            $display("inner chain busy=%0d done=%0d error=%0d merge_done=%0d stage5_done=%0d phase=%0d", dut.u_single_block_chain.busy, dut.u_single_block_chain.done, dut.u_single_block_chain.error, dut.u_single_block_chain.chain_merge_done_i, dut.u_single_block_chain.chain_stage5_done_i, dut.u_single_block_chain.u_two_way_chain.phase);
            $finish_and_return(1);
        end
        if (error) begin
        ...
        $display("PASS: multiblock two-way feeder+merge+stage5 sequence preserved cross-block duplicate suppression");
        $finish_and_return(0);
    end
endmodule
